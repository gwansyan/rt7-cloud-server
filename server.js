...
// V4.8F1: no forced audio modal. Any user tap can unlock audio quietly without blocking UI.
document.addEventListener('click', function(){ try{ unlockAudio(true); }catch(e){} }, {capture:true});
document.addEventListener('touchstart', function(){ try{ unlockAudio(true); }catch(e){} }, {capture:true, passive:true});
